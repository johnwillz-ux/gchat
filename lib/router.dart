...
Route<dynamic> generateRoute(RouteSettings settings) {
  ...
  switch (settings.name) {
    ...
    case AuthVerification.routeName:

      /// Returns a [MaterialPageRoute] that builds the [AuthVerification].
      return MaterialPageRoute(builder: (context) => const AuthVerification());
